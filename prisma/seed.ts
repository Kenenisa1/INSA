...
async function main() {
  ...
  // Clear collections (idempotent for development)
  ...
  await prisma.post.create({
    data: {
      ...
      content:
        "Today I learned about the App Router, server components, and React server actions.",
      dayBadge: 1,
      authorId: student.id,
  ...
  await prisma.answer.create({
    data: {
      content:
        "Use revalidatePath from next/cache inside your server action after mutation.",
